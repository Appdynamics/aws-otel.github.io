...
- To use AppDynamics OpenTelemetry, you need a SaaS Controller version >=21.2.0, and an active AppDynamics Pro edition license.
- To enable Open Telemetry on Controllers < 21.1.0 with certain limitations, contact your AppDynamics account representative.

#### SaaS Controller version >=21.2.0
